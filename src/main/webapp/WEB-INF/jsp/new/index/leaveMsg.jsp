		...
		<div class="scroller" data-height="435px" data-always-visible="1"
			...
			<ul class="chats">
				<li class="in"><img class="avatar" alt=""
					src="media/image/avatar1.jpg" />
					<div class="message">
						<span class="arrow"></span> <a href="#" class="name">Bob
							Nilson</a> <span class="datetime">at Jul 25, 2012 11:09</span> <span
				...
				<li class="out"><img class="avatar" alt=""
					...
					<div class="message">
						<span class="arrow"></span> <a href="#" class="name">Bob
							...
							class="body"> Lorem ipsum dolor sit amet, consectetuer
							adipiscing elit, sed diam nonummy nibh euismod tincidunt ut
							laoreet dolore magna aliquam erat volutpat. sed diam nonummy nibh
							euismod tincidunt ut laoreet. </span>
					</div></li>
			</ul>
		</div>
		<div class="chat-form">
