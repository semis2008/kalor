...
<ul class="page-sidebar-menu">
	...
	<li class=""><a href="javascript:;"> <i class="icon-cogs"></i>
		...
		<ul class="sub-menu">
			<li><a href="layout_horizontal_sidebar_menu.html"> Horzontal
					& Sidebar Menu</a></li>
	...
	<li class=""><a href="javascript:;"> <i class="icon-briefcase"></i>
			<span class="title">关于</span> <span class="arrow "></span>
	</a>
		<ul class="sub-menu">
	...
	<li><a class="active" href="javascript:;"> <i
			class="icon-sitemap"></i> <span class="title">3 Level Menu</span> <span
			class="arrow "></span>
	</a>
		<ul class="sub-menu">
	...
	<li><a href="javascript:;"> <i class="icon-folder-open"></i> <span
		...
		<ul class="sub-menu">
			<li><a href="javascript:;"> <i class="icon-cogs"></i> Item 1
				...
				<ul class="sub-menu">
					<li><a href="javascript:;"> <i class="icon-user"></i>
						...
						<ul class="sub-menu">
							<li><a href="#"><i class="icon-remove"></i> Sample Link
									1</a></li>
					...
					<li><a href="#"><i class="icon-external-link"></i> Sample
							Link 2</a></li>
					<li><a href="#"><i class="icon-bell"></i> Sample Link 3</a></li>
				</ul></li>
			<li><a href="javascript:;"> <i class="icon-globe"></i> Item
	...
	<li class="last "><a href="charts.html"> <i
			class="icon-bar-chart"></i> <span class="title">Visual Charts</span>
	</a></li>
</ul>
<!-- END SIDEBAR MENU -->