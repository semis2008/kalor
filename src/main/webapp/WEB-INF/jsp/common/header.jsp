	...
	<div class="navbar-inner">
		<div class="container-fluid">
			...
			<a href="javascript:;" class="btn-navbar collapsed"
				...
				src="<%=staticPath%>/image/menu-toggler.png" alt="" />
			</a>
			...
			<ul class="nav pull-right">
				...
				<li class="dropdown" id="header_inbox_bar"><a href="#"
					...
					<ul class="dropdown-menu extended inbox">
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="<%=staticPath%>/image/avatar2.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="./<%=staticPath%>/image/avatar3.jpg" alt="" /></span> <span
						...
						<li><a href="inbox.html?a=view"> <span class="photo"><img
									src="./<%=staticPath%>/image/avatar1.jpg" alt="" /></span> <span
				...
				<li class="dropdown user"><a href="#" class="dropdown-toggle"
					data-toggle="dropdown"> <img alt=""
						src="<%=staticPath%>/image/avatar1_small.jpg" /> <span
