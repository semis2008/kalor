...
<article> <section id="editDiarySec">
<h3 class="major">
	<span><i class="icon-edit"></i> 编辑日志</span>
</h3>
<div class="padding-small">
	<div class="input-prepend">
		<span class="add-on"><i class="icon-quote-left"></i> </span><input
			type="text" id="diaryTitle" name="diaryTitle" class="span4"
			placeholder="点击输入标题" required ><%=diary.getTitle() %></input>
	</div>
...
<div class="padding-small">
	<div class="btn-toolbar" data-role="editor-toolbar"
		...
		<div class="btn-group">
			...
			</a> <a class="btn" data-edit="strikethrough" title="贯穿线"
...
<div class="padding-small">
	<div class="input-prepend">
		<span class="add-on"><i class="icon-tags"></i> </span><input
			...
			placeholder="标签" required ><%=diary.getTags().replaceAll("_"," ") %></input>
	</div>
